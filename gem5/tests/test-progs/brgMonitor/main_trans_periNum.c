...
#define ANum 20	// acceleration collection number in one packet 
#define PeriNum 3
...
int main()
{
	...
	for (j=0; j<PeriNum/2; j++)
	{
		...
		for(i=1; i<=60; i++)
		{
			...
			//generalVdevActive(gvdev2_reg);
			//generalVdevActive(gvdev3_reg);
			//generalVdevActive(gvdev4_reg);
			//generalVdevActive(gvdev5_reg);
