...
system.vdev1.energy_consumed_per_cycle_vdev = [0, 0.25*100, 1.75*100]	# nJ
...
system.vdev1.energy_consumed_per_cycle_vdev = [0, 0.5*100, 1.5*100] # The energy consumption of each cycle at power-off, idle and active mode.
...
system.vdev1.energy_consumed_per_cycle_vdev = [0, 0.1*100, 10.5*100]
