...
system.has_vdev = 1
system.vdev_ranges = [AddrRange('512MB', '512MB'), AddrRange('513MB', '513MB')]
system.vaddr_vdev_ranges = [AddrRange('1000MB', '1000MB'), AddrRange('1001MB', '1001MB')]
...
process = LiveProcess()
process.cmd = ['tests/test-progs/multi_vdev/bin/arm/linux/multi_vdev']
