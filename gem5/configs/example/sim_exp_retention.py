...
system.energy_mgmt.state_machine = RetentionEnergySM()
# Threshold Design for the state machine
system.energy_mgmt.state_machine.thres_ret_to_off = 0.5 * cap * 1000 * 1.1 * 1.1
system.energy_mgmt.state_machine.thres_1_to_ret = 0.5 * cap * 1000 * 2.1 * 2.1
system.energy_mgmt.state_machine.thres_ret_to_1 = 0.5 * cap * 1000 * 4.5 *4.5
